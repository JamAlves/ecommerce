    ...
    <section class="invoice">
        ...
        <div class="row">
            ...
            <h2 class="page-header">
                ...
                <small class="pull-right">Date: {formatDate('d/m/Y')"}</small>
            </h2>
            </div>
            <!-- /.col -->
        </div>
        ...
        <div class="row">
            ...
            <div class="table-responsive">
                ...
                <tbody><tr>
                    ...
                    <td>R$<?php echo formatDate($cart["vlsubtotal"]); ?></td>
                </tr>
                <tr>
                    <th>Frete:</th>
                    <td>R$<?php echo formatDate($cart["vlfreight"]); ?></td>
                </tr>
                <tr>
                    <th>Total:</th>
                    <td>R$<?php echo formatDate($cart["vltotal"]); ?></td>
                </tr>
                </tbody></table>
            </div>
            </div>
